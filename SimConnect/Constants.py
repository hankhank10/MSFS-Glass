...
SIMCONNECT_OBJECT_ID_USER = DWORD(0)  # deprecated - proxy legacy value for User aircraft ObjectID
SIMCONNECT_OBJECT_ID_MAX = DWORD(DWORD_MAX.value - 128)  # proxy value for User vehicle ObjectID
SIMCONNECT_OBJECT_ID_USER_AIRCRAFT = DWORD(0)  # proxy value for User aircraft ObjectID
SIMCONNECT_OBJECT_ID_USER_AVATAR = DWORD(SIMCONNECT_OBJECT_ID_MAX.value + 1)  # proxy value for User avatar ObjectID
SIMCONNECT_OBJECT_ID_USER_CURRENT = DWORD(SIMCONNECT_OBJECT_ID_MAX.value + 2) # proxy value for User aircraft/avatar ObjectID
