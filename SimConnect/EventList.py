...
class AircraftEvents():
	...
	class __Autopilot(EventHelper):
		list = [
			...
			(b'AP_PANEL_VS_HOLD', "Toggles vertical speed hold mode on/off", "Shared Cockpit"),
			(b'AP_PANEL_VS_OFF', "Turns off vertical speed hold mode", "Shared Cockpit"),
			(b'AP_PANEL_VS_ON', "Turns on vertical speed hold mode", "Shared Cockpit"),
	...
	class __Avionics(EventHelper):
		list = [
			...
			(b'ADF1_RADIO_SWAP', "Swaps ADF1 frequency with standby", "Shared Cockpit"),
			...
			(b'COM_1_SPACING_MODE_SWITCH', "Toggle COM 1 frequency spacing", "All aircraft"),
			(b'COM_2_SPACING_MODE_SWITCH', "Toggle COM 2 frequency spacing", "All aircraft"),
			...
			# Mobiflight Events
			(b'MobiFlight.AS1000_PFD_SOFTKEYS_1', "-", "Shared Cockpit"),
			(b'MobiFlight.AS1000_PFD_SOFTKEYS_2', "-", "Shared Cockpit"),
			(b'MobiFlight.AS1000_PFD_SOFTKEYS_3', "-", "Shared Cockpit"),
			(b'MobiFlight.AS1000_PFD_SOFTKEYS_4', "-", "Shared Cockpit"),
			(b'MobiFlight.AS1000_PFD_SOFTKEYS_5', "-", "Shared Cockpit"),
			(b'MobiFlight.AS1000_PFD_SOFTKEYS_6', "-", "Shared Cockpit"),
			(b'MobiFlight.AS1000_PFD_SOFTKEYS_7', "-", "Shared Cockpit"),
			(b'MobiFlight.AS1000_PFD_SOFTKEYS_8', "-", "Shared Cockpit"),
			(b'MobiFlight.AS1000_PFD_SOFTKEYS_9', "-", "Shared Cockpit"),
			(b'MobiFlight.AS1000_PFD_SOFTKEYS_10', "-", "Shared Cockpit"),
			(b'MobiFlight.AS1000_PFD_SOFTKEYS_11', "-", "Shared Cockpit"),
			(b'MobiFlight.AS1000_PFD_SOFTKEYS_12', "-", "Shared Cockpit"),
			(b'MobiFlight.AS1000_PFD_FMS_Lower_DEC', "-", "Shared Cockpit"),
			(b'MobiFlight.AS1000_PFD_FMS_Lower_INC', "-", "Shared Cockpit"),
			(b'MobiFlight.AS1000_PFD_FMS_Upper_DEC', "-", "Shared Cockpit"),
			(b'MobiFlight.AS1000_PFD_FMS_Upper_INC', "-", "Shared Cockpit"),
			(b'MobiFlight.AS1000_PFD_FMS_Upper_PUSH', "-", "Shared Cockpit"),
			(b'MobiFlight.AS1000_PFD_JOYSTICK_LEFT', "-", "Shared Cockpit"),
			(b'MobiFlight.AS1000_PFD_JOYSTICK_UP', "-", "Shared Cockpit"),
			(b'MobiFlight.AS1000_PFD_JOYSTICK_DOWN', "-", "Shared Cockpit"),
			(b'MobiFlight.AS1000_PFD_JOYSTICK_RIGHT', "-", "Shared Cockpit"),
			(b'MobiFlight.AS1000_PFD_JOYSTICK_PUSH', "-", "Shared Cockpit"),
			(b'MobiFlight.AS1000_PFD_RANGE_DEC', "-", "Shared Cockpit"),
			(b'MobiFlight.AS1000_PFD_RANGE_INC', "-", "Shared Cockpit"),
			(b'MobiFlight.AS1000_PFD_ActivateMapCursor', "-", "Shared Cockpit"),
			(b'MobiFlight.AS1000_PFD_DeactivateMapCursor', "-", "Shared Cockpit"),
			(b'MobiFlight.AS1000_PFD_DIRECTTO', "-", "Shared Cockpit"),
			(b'MobiFlight.AS1000_PFD_MENU_Push', "-", "Shared Cockpit"),
			(b'MobiFlight.AS1000_PFD_FPL_Push', "-", "Shared Cockpit"),
			(b'MobiFlight.AS1000_PFD_PROC_Push', "-", "Shared Cockpit"),
			(b'MobiFlight.AS1000_PFD_CLR', "-", "Shared Cockpit"),
			(b'MobiFlight.AS1000_PFD_ENT_Push', "-", "Shared Cockpit"),
			(b'MobiFlight.AS1000_PFD_CLR_Long', "-", "Shared Cockpit"),
			(b'MobiFlight.AS1000_MFD_SOFTKEYS_1', "-", "Shared Cockpit"),
			(b'MobiFlight.AS1000_MFD_SOFTKEYS_2', "-", "Shared Cockpit"),
			(b'MobiFlight.AS1000_MFD_SOFTKEYS_3', "-", "Shared Cockpit"),
			(b'MobiFlight.AS1000_MFD_SOFTKEYS_4', "-", "Shared Cockpit"),
			(b'MobiFlight.AS1000_MFD_SOFTKEYS_5', "-", "Shared Cockpit"),
			(b'MobiFlight.AS1000_MFD_SOFTKEYS_6', "-", "Shared Cockpit"),
			(b'MobiFlight.AS1000_MFD_SOFTKEYS_7', "-", "Shared Cockpit"),
			(b'MobiFlight.AS1000_MFD_SOFTKEYS_8', "-", "Shared Cockpit"),
			(b'MobiFlight.AS1000_MFD_SOFTKEYS_9', "-", "Shared Cockpit"),
			(b'MobiFlight.AS1000_MFD_SOFTKEYS_10', "-", "Shared Cockpit"),
			(b'MobiFlight.AS1000_MFD_SOFTKEYS_11', "-", "Shared Cockpit"),
			(b'MobiFlight.AS1000_MFD_SOFTKEYS_12', "-", "Shared Cockpit"),
			(b'MobiFlight.AS1000_MFD_FMS_Lower_DEC', "-", "Shared Cockpit"),
			(b'MobiFlight.AS1000_MFD_FMS_Lower_INC', "-", "Shared Cockpit"),
			(b'MobiFlight.AS1000_MFD_FMS_Upper_DEC', "-", "Shared Cockpit"),
			(b'MobiFlight.AS1000_MFD_FMS_Upper_INC', "-", "Shared Cockpit"),
			(b'MobiFlight.AS1000_MFD_FMS_Upper_PUSH', "-", "Shared Cockpit"),
			(b'MobiFlight.AS1000_MFD_JOYSTICK_LEFT', "-", "Shared Cockpit"),
			(b'MobiFlight.AS1000_MFD_JOYSTICK_UP', "-", "Shared Cockpit"),
			(b'MobiFlight.AS1000_MFD_JOYSTICK_DOWN', "-", "Shared Cockpit"),
			(b'MobiFlight.AS1000_MFD_JOYSTICK_RIGHT', "-", "Shared Cockpit"),
			(b'MobiFlight.AS1000_MFD_JOYSTICK_PUSH', "-", "Shared Cockpit"),
			(b'MobiFlight.AS1000_MFD_RANGE_DEC', "-", "Shared Cockpit"),
			(b'MobiFlight.AS1000_MFD_RANGE_INC', "-", "Shared Cockpit"),
			(b'MobiFlight.AS1000_MFD_ActivateMapCursor', "-", "Shared Cockpit"),
			(b'MobiFlight.AS1000_MFD_DeactivateMapCursor', "-", "Shared Cockpit"),
			(b'MobiFlight.AS1000_MFD_DIRECTTO', "-", "Shared Cockpit"),
			(b'MobiFlight.AS1000_MFD_MENU_Push', "-", "Shared Cockpit"),
			(b'MobiFlight.AS1000_MFD_FPL_Push', "-", "Shared Cockpit"),
			(b'MobiFlight.AS1000_MFD_PROC_Push', "-", "Shared Cockpit"),
			(b'MobiFlight.AS1000_MFD_CLR', "-", "Shared Cockpit"),
			(b'MobiFlight.AS1000_MFD_ENT_Push', "-", "Shared Cockpit"),
			(b'MobiFlight.AS1000_MFD_CLR_Long', "-", "Shared Cockpit"),
			(b'MobiFlight.XMLVAR_Baro1_Mode_QFE', "-", "Shared Cockpit"),
			(b'MobiFlight.XMLVAR_Baro1_Mode_QNH', "-", "Shared Cockpit"),
			(b'MobiFlight.XMLVAR_Baro1_Mode_STD', "-", "Shared Cockpit"),
			(b'MobiFlight.A320_Neo_MFD_BTN_CSTR_1', "-", "Shared Cockpit"),
			(b'MobiFlight.A320_Neo_MFD_BTN_WPT_1', "-", "Shared Cockpit"),
			(b'MobiFlight.A320_Neo_MFD_BTN_VORD_1', "-", "Shared Cockpit"),
			(b'MobiFlight.A320_Neo_MFD_BTN_NDB_1', "-", "Shared Cockpit"),
			(b'MobiFlight.A320_Neo_MFD_BTN_ARPT_1', "-", "Shared Cockpit"),
			(b'MobiFlight.A320_Neo_MFD_NAV_MODE_1_LS', "-", "Shared Cockpit"),
			(b'MobiFlight.A320_Neo_MFD_NAV_MODE_1_VOR', "-", "Shared Cockpit"),
			(b'MobiFlight.A320_Neo_MFD_NAV_MODE_1_NAV', "-", "Shared Cockpit"),
			(b'MobiFlight.A320_Neo_MFD_NAV_MODE_1_ARC', "-", "Shared Cockpit"),
			(b'MobiFlight.A320_Neo_MFD_NAV_MODE_1_PLAN', "-", "Shared Cockpit"),
			(b'MobiFlight.A320_neo_MFD_Range_1_10', "-", "Shared Cockpit"),
			(b'MobiFlight.A320_neo_MFD_Range_1_20', "-", "Shared Cockpit"),
			(b'MobiFlight.A320_neo_MFD_Range_1_40', "-", "Shared Cockpit"),
			(b'MobiFlight.A320_neo_MFD_Range_1_80', "-", "Shared Cockpit"),
			(b'MobiFlight.A320_neo_MFD_Range_1_160', "-", "Shared Cockpit"),
			(b'MobiFlight.A320_neo_MFD_Range_1_320', "-", "Shared Cockpit"),
			(b'MobiFlight.XMLVAR_NAV_AID_SWITCH_L1_State_Off', "-", "Shared Cockpit"),
			(b'MobiFlight.XMLVAR_NAV_AID_SWITCH_L1_State_ADF', "-", "Shared Cockpit"),
			(b'MobiFlight.XMLVAR_NAV_AID_SWITCH_L1_State_VOR', "-", "Shared Cockpit"),
			(b'MobiFlight.XMLVAR_NAV_AID_SWITCH_L2_State_Off', "-", "Shared Cockpit"),
			(b'MobiFlight.XMLVAR_NAV_AID_SWITCH_L2_State_ADF', "-", "Shared Cockpit"),
			(b'MobiFlight.XMLVAR_NAV_AID_SWITCH_L2_State_VOR', "-", "Shared Cockpit"),
			(b'MobiFlight.A320_Neo_PFD_BTN_LS_1', "-", "Shared Cockpit"),
			(b'MobiFlight.AS530_OBS_Push', "-", "Shared Cockpit"),
			(b'MobiFlight.AS530_MSG_Push', "-", "Shared Cockpit"),
			(b'MobiFlight.AS530_FPL_Push', "-", "Shared Cockpit"),
			(b'MobiFlight.AS530_VNAV_Push', "-", "Shared Cockpit"),
			(b'MobiFlight.AS530_PROC_Push', "-", "Shared Cockpit"),
			(b'MobiFlight.AS530_DirectTo_Push', "-", "Shared Cockpit"),
			(b'MobiFlight.AS530_MENU_Push', "-", "Shared Cockpit"),
			(b'MobiFlight.AS530_CLR_Push', "-", "Shared Cockpit"),
			(b'MobiFlight.AS530_ENT_Push', "-", "Shared Cockpit"),
			(b'MobiFlight.AS530_CLR_Push_Long', "-", "Shared Cockpit"),
			(b'MobiFlight.AS530_RNG_Zoom', "-", "Shared Cockpit"),
			(b'MobiFlight.AS530_RNG_Dezoom', "-", "Shared Cockpit"),
			(b'MobiFlight.AS530_RightLargeKnob_Left', "-", "Shared Cockpit"),
			(b'MobiFlight.AS530_RightSmallKnob_Left', "-", "Shared Cockpit"),
			(b'MobiFlight.AS530_RightSmallKnob_Push', "-", "Shared Cockpit"),
			(b'MobiFlight.AS530_RightSmallKnob_Right', "-", "Shared Cockpit"),
			(b'MobiFlight.AS530_RightLargeKnob_Right', "-", "Shared Cockpit"),
			(b'MobiFlight.AS430_OBS_Push', "-", "Shared Cockpit"),
			(b'MobiFlight.AS430_MSG_Push', "-", "Shared Cockpit"),
			(b'MobiFlight.AS430_FPL_Push', "-", "Shared Cockpit"),
			(b'MobiFlight.AS430_PROC_Push', "-", "Shared Cockpit"),
			(b'MobiFlight.AS430_DirectTo_Push', "-", "Shared Cockpit"),
			(b'MobiFlight.AS430_MENU_Push', "-", "Shared Cockpit"),
			(b'MobiFlight.AS430_CLR_Push', "-", "Shared Cockpit"),
			(b'MobiFlight.AS430_ENT_Push', "-", "Shared Cockpit"),
			(b'MobiFlight.AS430_CLR_Push_Long', "-", "Shared Cockpit"),
			(b'MobiFlight.AS430_RNG_Zoom', "-", "Shared Cockpit"),
			(b'MobiFlight.AS430_RNG_Dezoom', "-", "Shared Cockpit"),
			(b'MobiFlight.AS430_RightLargeKnob_Left', "-", "Shared Cockpit"),
			(b'MobiFlight.AS430_RightSmallKnob_Left', "-", "Shared Cockpit"),
			(b'MobiFlight.AS430_RightSmallKnob_Push', "-", "Shared Cockpit"),
			(b'MobiFlight.AS430_RightSmallKnob_Right', "-", "Shared Cockpit"),
			(b'MobiFlight.AS430_RightLargeKnob_Right', "-", "Shared Cockpit"),
			# Mobiflight Custom
			(b'MobiFlight.A32NX_PROBE_WINDOW_HEAT_OFF', "-", "Shared Cockpit"),
			(b'MobiFlight.A32NX_PROBE_WINDOW_HEAT_ON', "-", "Shared Cockpit"),
			(b'MobiFlight.A32NX_PROBE_WINDOW_HEAT_toggle', "-", "Shared Cockpit"),
			(b'MobiFlight.A32NX_AUTOPILOT_LOC_MODE_toggle', "-", "Shared Cockpit"),
			(b'MobiFlight.A32NX_AUTOPILOT_APPR_MODE_toggle', "-", "Shared Cockpit"),
			(b'MobiFlight.JF_ARROW_AUTOPILOT_MODE_NAV', "-", "Shared Cockpit"),
			(b'MobiFlight.JF_ARROW_AUTOPILOT_MODE_OMNI', "-", "Shared Cockpit"),
			(b'MobiFlight.JF_ARROW_AUTOPILOT_MODE_HDG', "-", "Shared Cockpit"),
			(b'MobiFlight.JF_ARROW_AUTOPILOT_MODE_LOCNOMR', "-", "Shared Cockpit"),
			(b'MobiFlight.JF_ARROW_AUTOPILOT_MODE_LOCREV', "-", "Shared Cockpit"),
			(b'MobiFlight.JF_ARROW_AUTOPILOT_HDG_Toggle', "-", "Shared Cockpit"),
			(b'MobiFlight.JF_ARROW_DME_NAV1', "-", "Shared Cockpit"),
			(b'MobiFlight.JF_ARROW_DME_NAV2', "-", "Shared Cockpit"),
			(b'MobiFlight.JF_ARROW_KX170_NAV1_OUTER_KNOB_PLUS', "-", "Shared Cockpit"),
			(b'MobiFlight.JF_ARROW_KX170_NAV1_OUTER_KNOB_MINUS', "-", "Shared Cockpit"),
			(b'MobiFlight.JF_ARROW_KX170_NAV1_INNER_KNOB_PLUS', "-", "Shared Cockpit"),
			(b'MobiFlight.JF_ARROW_KX170_NAV1_INNER_KNOB_MINUS', "-", "Shared Cockpit"),
			(b'MobiFlight.JF_ARROW_KX175_NAV2_OUTER_KNOB_PLUS', "-", "Shared Cockpit"),
			(b'MobiFlight.JF_ARROW_KX175_NAV2_OUTER_KNOB_MINUS', "-", "Shared Cockpit"),
			(b'MobiFlight.JF_ARROW_KX175_NAV2_INNER_KNOB_PLUS', "-", "Shared Cockpit"),
			(b'MobiFlight.JF_ARROW_KX175_NAV2_INNER_KNOB_MINUS', "-", "Shared Cockpit"),
			(b'MobiFlight.JF_ARROW_KX170_COMM1_OUTER_KNOB_PLUS', "-", "Shared Cockpit"),
			(b'MobiFlight.JF_ARROW_KX170_COMM1_OUTER_KNOB_MINUS', "-", "Shared Cockpit"),
			(b'MobiFlight.JF_ARROW_KX170_COMM1_INNER_KNOB_PLUS', "-", "Shared Cockpit"),
			(b'MobiFlight.JF_ARROW_KX170_COMM1_INNER_KNOB_MINUS', "-", "Shared Cockpit"),
			(b'MobiFlight.JF_ARROW_KX175_COMM2_OUTER_KNOB_PLUS', "-", "Shared Cockpit"),
			(b'MobiFlight.JF_ARROW_KX175_COMM2_OUTER_KNOB_MINUS', "-", "Shared Cockpit"),
			(b'MobiFlight.JF_ARROW_KX175_COMM2_INNER_KNOB_PLUS', "-", "Shared Cockpit"),
			(b'MobiFlight.JF_ARROW_KX175_COMM2_INNER_KNOB_MINUS', "-", "Shared Cockpit"),
			(b'MobiFlight.JF_ARROW_COM1_TRANSMIT', "-", "Shared Cockpit"),
			(b'MobiFlight.JF_ARROW_COM2_TRANSMIT', "-", "Shared Cockpit"),
			(b'MobiFlight.JF_ARROW_AUTOPILOT_ROLL_30L', "-", "Shared Cockpit"),
			(b'MobiFlight.JF_ARROW_AUTOPILOT_ROLL_20L', "-", "Shared Cockpit"),
			(b'MobiFlight.JF_ARROW_AUTOPILOT_ROLL_10L', "-", "Shared Cockpit"),
			(b'MobiFlight.JF_ARROW_AUTOPILOT_ROLL_0', "-", "Shared Cockpit"),
			(b'MobiFlight.JF_ARROW_AUTOPILOT_ROLL_10R', "-", "Shared Cockpit"),
			(b'MobiFlight.JF_ARROW_AUTOPILOT_ROLL_20R', "-", "Shared Cockpit"),
			(b'MobiFlight.JF_ARROW_AUTOPILOT_ROLL_30R', "-", "Shared Cockpit"),
			(b'MobiFlight.JF_ARROW_AUTOPILOT_SOURCE_NAV1', "-", "Shared Cockpit"),
			(b'MobiFlight.JF_ARROW_AUTOPILOT_SOURCE_NAV2', "-", "Shared Cockpit"),
			(b'MobiFlight.JF_ARROW_AUTOPILOT_SOURCE_OFF', "-", "Shared Cockpit"),
			(b'MobiFlight.JF_ARROW_FUEL_SELECT_cut', "-", "Shared Cockpit"),
			(b'MobiFlight.JF_ARROW_FUEL_SELECT_left', "-", "Shared Cockpit"),
			(b'MobiFlight.JF_ARROW_FUEL_SELECT_right', "-", "Shared Cockpit"),
			(b'MobiFlight.JF_ARROW_FLIGHT_BAG_toggle', "-", "Shared Cockpit"),
			(b'MobiFlight.JF_ARROW_LIGHTS_PANEL_toggle', "-", "Shared Cockpit"),
			(b'MobiFlight.JF_ARROW_LIGHTS_BCN_on', "-", "Shared Cockpit"),
			(b'MobiFlight.JF_ARROW_LIGHTS_BCN_off', "-", "Shared Cockpit"),
			(b'MobiFlight.JF_ARROW_LIGHTS_BCN_toggle', "-", "Shared Cockpit"),
			(b'MobiFlight.JF_ARROW_PITOT_HEAT_toggle', "-", "Shared Cockpit"),
			(b'MobiFlight.JF_ARROW_GPS100_RTE_press', "-", "Shared Cockpit"),
			(b'MobiFlight.JF_ARROW_GPS100_RTE_release', "-", "Shared Cockpit"),
			(b'MobiFlight.JF_ARROW_GPS100_WPT_press', "-", "Shared Cockpit"),
			(b'MobiFlight.JF_ARROW_GPS100_WPT_release', "-", "Shared Cockpit"),
			(b'MobiFlight.JF_ARROW_GPS100_NAV_press', "-", "Shared Cockpit"),
			(b'MobiFlight.JF_ARROW_GPS100_NAV_release', "-", "Shared Cockpit"),
			...
			(b'MobiFlight.ASCRJ_LSP_BRG2', "-", "Shared Cockpit"),
			(b'MobiFlight.ASCRJ_LSP_BRG2_rel', "-", "Shared Cockpit"),
			(b'MobiFlight.ASCRJ_LSP_FORMAT_right', "-", "Shared Cockpit"),
			(b'MobiFlight.ASCRJ_LSP_FORMAT_left', "-", "Shared Cockpit"),
			(b'MobiFlight.ASCRJ_LSP_RANGE_right', "-", "Shared Cockpit"),
			(b'MobiFlight.ASCRJ_LSP_RANGE_left', "-", "Shared Cockpit"),
			(b'MobiFlight.ASCRJ_LSP_RDR', "-", "Shared Cockpit"),
			(b'MobiFlight.ASCRJ_LSP_RDR_rel', "-", "Shared Cockpit"),
			(b'MobiFlight.ASCRJ_LSP_TFC', "-", "Shared Cockpit"),
			(b'MobiFlight.ASCRJ_LSP_TFC_rel', "-", "Shared Cockpit"),
			(b'MobiFlight.ASCRJ_LSP_NAV_SOURCE_right', "-", "Shared Cockpit"),
			(b'MobiFlight.ASCRJ_LSP_NAV_SOURCE_left', "-", "Shared Cockpit"),
			(b'MobiFlight.ASCRJ_LSP_NAV_SOURCE_XSIDE', "-", "Shared Cockpit"),
			(b'MobiFlight.ASCRJ_LSP_NAV_SOURCE_XSIDE_rel', "-", "Shared Cockpit"),
			(b'MobiFlight.ASCRJ_LSP_SEL', "-", "Shared Cockpit"),
			(b'MobiFlight.ASCRJ_LSP_SEL_rel', "-", "Shared Cockpit"),
			(b'MobiFlight.ASCRJ_LSP_TGT', "-", "Shared Cockpit"),
			(b'MobiFlight.ASCRJ_LSP_VSPD', "-", "Shared Cockpit"),
			(b'MobiFlight.ASCRJ_LSP_SPEED_SEL_right', "-", "Shared Cockpit"),
			(b'MobiFlight.ASCRJ_LSP_SPEED_SEL_left', "-", "Shared Cockpit"),
			(b'MobiFlight.ASCRJ_LSP_SPEED_SET', "-", "Shared Cockpit"),
			(b'MobiFlight.ASCRJ_LSP_SPEED_SET_rel', "-", "Shared Cockpit"),
			(b'MobiFlight.ASCRJ_LSP_DH', "-", "Shared Cockpit"),
			(b'MobiFlight.ASCRJ_LSP_MDA', "-", "Shared Cockpit"),
			(b'MobiFlight.ASCRJ_LSP_HEIGHT_SEL_right', "-", "Shared Cockpit"),
			(b'MobiFlight.ASCRJ_LSP_HEIGHT_SEL_left', "-", "Shared Cockpit"),
			(b'MobiFlight.ASCRJ_LSP_HEIGHT_SET', "-", "Shared Cockpit"),
			(b'MobiFlight.ASCRJ_LSP_HEIGHT_SET_rel', "-", "Shared Cockpit"),
			(b'MobiFlight.ASCRJ_LSP_HPAIN', "-", "Shared Cockpit"),
			(b'MobiFlight.ASCRJ_LSP_HPAIN_rel', "-", "Shared Cockpit"),
			(b'MobiFlight.ASCRJ_LSP_BARO_right', "-", "Shared Cockpit"),
			(b'MobiFlight.ASCRJ_LSP_BARO_left', "-", "Shared Cockpit"),
			(b'MobiFlight.ASCRJ_LSP_BARO_STD', "-", "Shared Cockpit"),
			(b'MobiFlight.ASCRJ_LSP_BARO_STD_rel', "-", "Shared Cockpit"),
			(b'MobiFlight.ASCRJ_FCP_CRS1_PLUS', "-", "Shared Cockpit"),
			(b'MobiFlight.ASCRJ_FCP_CRS1_MINUS', "-", "Shared Cockpit"),
			(b'MobiFlight.ASCRJ_FCP_CRS1_DIRECT', "-", "Shared Cockpit"),
			(b'MobiFlight.ASCRJ_FCP_CRS1_DIRECT_rel', "-", "Shared Cockpit"),
			(b'MobiFlight.ASCRJ_FCP_CRS2_PLUS', "-", "Shared Cockpit"),
			(b'MobiFlight.ASCRJ_FCP_CRS2_MINUS', "-", "Shared Cockpit"),
			(b'MobiFlight.ASCRJ_FCP_CRS2_DIRECT', "-", "Shared Cockpit"),
			(b'MobiFlight.ASCRJ_FCP_CRS2_DIRECT_rel', "-", "Shared Cockpit"),
			(b'MobiFlight.ASCRJ_FCP_FD', "-", "Shared Cockpit"),
			(b'MobiFlight.ASCRJ_FCP_XFR', "-", "Shared Cockpit"),
			(b'MobiFlight.ASCRJ_FCP_XFR_rel', "-", "Shared Cockpit"),
			(b'MobiFlight.ASCRJ_FCP_TURB', "-", "Shared Cockpit"),
			(b'MobiFlight.ASCRJ_FCP_TURB_rel', "-", "Shared Cockpit"),
			(b'MobiFlight.ASCRJ_FCP_SPEED', "-", "Shared Cockpit"),
			(b'MobiFlight.ASCRJ_FCP_SPEED_rel', "-", "Shared Cockpit"),
			(b'MobiFlight.ASCRJ_FCP_IAS_MACH', "-", "Shared Cockpit"),
			(b'MobiFlight.ASCRJ_FCP_IAS_MACH_rel', "-", "Shared Cockpit"),
			(b'MobiFlight.ASCRJ_FCP_SPEED_plus', "-", "Shared Cockpit"),
			(b'MobiFlight.ASCRJ_FCP_SPEED_plus10', "-", "Shared Cockpit"),
			(b'MobiFlight.ASCRJ_FCP_SPEED_minus', "-", "Shared Cockpit"),
			(b'MobiFlight.ASCRJ_FCP_SPEED_minus10', "-", "Shared Cockpit"),
			(b'MobiFlight.ASCRJ_FCP_APPR', "-", "Shared Cockpit"),
			(b'MobiFlight.ASCRJ_FCP_APPR_rel', "-", "Shared Cockpit"),
			(b'MobiFlight.ASCRJ_FCP_BC', "-", "Shared Cockpit"),
			(b'MobiFlight.ASCRJ_FCP_BC_rel', "-", "Shared Cockpit"),
			(b'MobiFlight.ASCRJ_FCP_HDG', "-", "Shared Cockpit"),
			(b'MobiFlight.ASCRJ_FCP_HDG_rel', "-", "Shared Cockpit"),
			(b'MobiFlight.ASCRJ_FCP_HDG_SYNC', "-", "Shared Cockpit"),
			(b'MobiFlight.ASCRJ_FCP_HDG_SYNC_rel', "-", "Shared Cockpit"),
			(b'MobiFlight.ASCRJ_FCP_HDG_INFO_plus1', "-", "Shared Cockpit"),
			(b'MobiFlight.ASCRJ_FCP_HDG_INFO_plus10', "-", "Shared Cockpit"),
			(b'MobiFlight.ASCRJ_FCP_HDG_INFO_minus10', "-", "Shared Cockpit"),
			(b'MobiFlight.ASCRJ_FCP_HDG_INFO_minus1', "-", "Shared Cockpit"),
			(b'MobiFlight.ASCRJ_FCP_NAV', "-", "Shared Cockpit"),
			(b'MobiFlight.ASCRJ_FCP_NAV_rel', "-", "Shared Cockpit"),
			(b'MobiFlight.ASCRJ_FCP_12BANK', "-", "Shared Cockpit"),
			(b'MobiFlight.ASCRJ_FCP_12BANK_rel', "-", "Shared Cockpit"),
			(b'MobiFlight.ASCRJ_FCP_ALT', "-", "Shared Cockpit"),
			(b'MobiFlight.ASCRJ_FCP_ALT_rel', "-", "Shared Cockpit"),
			(b'MobiFlight.ASCRJ_FCP_ALT_INFO_plus100', "-", "Shared Cockpit"),
			(b'MobiFlight.ASCRJ_FCP_ALT_INFO_plus1000', "-", "Shared Cockpit"),
			(b'MobiFlight.ASCRJ_FCP_ALT_INFO_minus1000', "-", "Shared Cockpit"),
			(b'MobiFlight.ASCRJ_FCP_ALT_INFO_minus100', "-", "Shared Cockpit"),
			(b'MobiFlight.ASCRJ_FCP_ALT_CANCEL', "-", "Shared Cockpit"),
			(b'MobiFlight.ASCRJ_FCP_ALT_CANCEL_rel', "-", "Shared Cockpit"),
			(b'MobiFlight.ASCRJ_FCP_VS', "-", "Shared Cockpit"),
			(b'MobiFlight.ASCRJ_FCP_VS_rel', "-", "Shared Cockpit"),
			(b'MobiFlight.ASCRJ_FCP_WHEEL_up', "-", "Shared Cockpit"),
			(b'MobiFlight.ASCRJ_FCP_WHEEL_up2', "-", "Shared Cockpit"),
			(b'MobiFlight.ASCRJ_FCP_WHEEL_down', "-", "Shared Cockpit"),
			(b'MobiFlight.ASCRJ_FCP_WHEEL_down2', "-", "Shared Cockpit"),
			(b'MobiFlight.ASCRJ_NAV1_OUTER_MINUS', "-", "Shared Cockpit"),
			(b'MobiFlight.ASCRJ_NAV1_OUTER_PLUS', "-", "Shared Cockpit"),
			(b'MobiFlight.ASCRJ_NAV1_INNER_MINUS', "-", "Shared Cockpit"),
			(b'MobiFlight.ASCRJ_NAV1_INNER_PLUS', "-", "Shared Cockpit"),
			(b'MobiFlight.ASCRJ_NAV2_OUTER_MINUS', "-", "Shared Cockpit"),
			(b'MobiFlight.ASCRJ_NAV2_OUTER_PLUS', "-", "Shared Cockpit"),
			...
			(b'MobiFlight.MV_COR_OIL_COOLER_MINUS', "-", "Shared Cockpit"),
			(b'MobiFlight.MV_COR_OIL_COOLER_PAUSE', "-", "Shared Cockpit"),
			(b'MobiFlight.MV_COR_OIL_COOLER_PLUS', "-", "Shared Cockpit"),
			(b'MobiFlight.MV_COR_INTERCOOLER_MINUS', "-", "Shared Cockpit"),
			(b'MobiFlight.MV_COR_INTERCOOLER_PAUSE', "-", "Shared Cockpit"),
			(b'MobiFlight.MV_COR_INTERCOOLER_PLUS', "-", "Shared Cockpit"),
			(b'MobiFlight.MV_COR_COWL_FLAP_MINUS', "-", "Shared Cockpit"),
			(b'MobiFlight.MV_COR_COWL_FLAP_PAUSE', "-", "Shared Cockpit"),
			(b'MobiFlight.MV_COR_COWL_FLAP_PLUS', "-", "Shared Cockpit"),
			(b'MobiFlight.MV_COR_FUEL_PUMP_TOGGLE', "-", "Shared Cockpit"),
			(b'MobiFlight.MV_COR_HEADING_PLUS', "-", "Shared Cockpit"),
			(b'MobiFlight.MV_COR_HEADING_MINUS', "-", "Shared Cockpit"),
			(b'MobiFlight.MV_COR_SUPERCHARGER_PLUS', "-", "Shared Cockpit"),
			(b'MobiFlight.MV_COR_SUPERCHARGER_MINUS', "-", "Shared Cockpit"),
			(b'MobiFlight.MV_COR_EXT_STEADY', "-", "Shared Cockpit"),
			(b'MobiFlight.MV_COR_EXT_OFF', "-", "Shared Cockpit"),
			(b'MobiFlight.MV_COR_EXT_FLASH', "-", "Shared Cockpit"),
			(b'MobiFlight.MV_COR_WING_BRIGHT', "-", "Shared Cockpit"),
			(b'MobiFlight.MV_COR_WING_OFF', "-", "Shared Cockpit"),
			(b'MobiFlight.MV_COR_WING_DIM', "-", "Shared Cockpit"),
			(b'MobiFlight.MV_COR_OIL_COOLER_MINUS', "-", "Shared Cockpit"),
			(b'MobiFlight.MV_COR_OIL_COOLER_PLUS', "-", "Shared Cockpit"),
			(b'MobiFlight.MV_COR_INTERCOOLER_MINUS', "-", "Shared Cockpit"),
			(b'MobiFlight.MV_COR_INTERCOOLER_PLUS', "-", "Shared Cockpit"),
			(b'MobiFlight.MV_COR_COWL_FLAP_MINUS', "-", "Shared Cockpit"),
			(b'MobiFlight.MV_COR_COWL_FLAP_PLUS', "-", "Shared Cockpit"),
			(b'MobiFlight.MV_COR_LOCK_TAILWHEEL', "-", "Shared Cockpit"),
			(b'MobiFlight.MV_COR_FUEL_MAIN', "-", "Shared Cockpit"),
			(b'MobiFlight.MV_COR_FUEL_RESERVE', "-", "Shared Cockpit"),
			(b'MobiFlight.MV_COR_FUEL_RH', "-", "Shared Cockpit"),
			(b'MobiFlight.MV_COR_FUEL_LH', "-", "Shared Cockpit"),
			(b'MobiFlight.MV_COR_FUEL_CENTER', "-", "Shared Cockpit"),
			(b'MobiFlight.MV_COR_FUEL_OFF', "-", "Shared Cockpit"),
			(b'MobiFlight.MV_COR_GUN_LIGHT', "-", "Shared Cockpit"),
			(b'MobiFlight.MV_COR_GUN_OFF', "-", "Shared Cockpit"),
			(b'MobiFlight.MV_COR_GUN_ALT', "-", "Shared Cockpit"),
			(b'MobiFlight.MV_COR_FUEL_PUMP_TOGGLE', "-", "Shared Cockpit"),
			(b'MobiFlight.MV_COR_SUPERCHARGER_PLUS', "-", "Shared Cockpit"),
			(b'MobiFlight.MV_COR_SUPERCHARGER_MINUS', "-", "Shared Cockpit"),
			(b'MobiFlight.MV_COR_HEADING_PLUS', "-", "Shared Cockpit"),
			...
			(b'MobiFlight.MV_COR_WING_OFF', "-", "Shared Cockpit"),
			(b'MobiFlight.MV_COR_WING_DIM', "-", "Shared Cockpit"),
			(b'MobiFlight.MV_COR_TAIL_BRIGHT', "-", "Shared Cockpit"),
			(b'MobiFlight.MV_COR_TAIL_OFF', "-", "Shared Cockpit"),
			(b'MobiFlight.MV_COR_TAIL_DIM', "-", "Shared Cockpit"),
			(b'MobiFlight.MV_COR_FORM_BRIGHT', "-", "Shared Cockpit"),
			(b'MobiFlight.MV_COR_FORM_OFF', "-", "Shared Cockpit"),
			(b'MobiFlight.MV_COR_FORM_DIM', "-", "Shared Cockpit"),
			(b'MobiFlight.MV_COR_SECTION_BRIGHT', "-", "Shared Cockpit"),
			(b'MobiFlight.MV_COR_SECTION_OFF', "-", "Shared Cockpit"),
			(b'MobiFlight.MV_COR_SECTION_DIM', "-", "Shared Cockpit"),
			(b'MobiFlight.MV_COR_SECSEL_BRIGHT', "-", "Shared Cockpit"),
			(b'MobiFlight.MV_COR_SECSEL_OFF', "-", "Shared Cockpit"),
			(b'MobiFlight.MV_COR_SECSEL_DIM', "-", "Shared Cockpit"),
			(b'MobiFlight.MV_COR_APP_ON', "-", "Shared Cockpit"),
			(b'MobiFlight.MV_COR_APP_OFF', "-", "Shared Cockpit"),
			(b'MobiFlight.MV_COR_APP_TOGGLE', "-", "Shared Cockpit"),
			(b'MobiFlight.MV_COR_COCKPIT_ON', "-", "Shared Cockpit"),
			(b'MobiFlight.MV_COR_COCKPIT_OFF', "-", "Shared Cockpit"),
			(b'MobiFlight.MV_COR_COCKPIT_TOGGLE', "-", "Shared Cockpit"),
			(b'MobiFlight.MV_COR_DEFROST_TOGGLE', "-", "Shared Cockpit"),
			(b'MobiFlight.MV_COR_PITOT_HEAT_TOGGLE', "-", "Shared Cockpit"),
			(b'MobiFlight.MV_COR_RECPT', "-", "Shared Cockpit"),
			(b'MobiFlight.MV_COR_BCN_DOWN', "-", "Shared Cockpit"),
			(b'MobiFlight.MV_COR_BCN_OFF', "-", "Shared Cockpit"),
			(b'MobiFlight.MV_COR_BCN_RED', "-", "Shared Cockpit"),
			(b'MobiFlight.MV_COR_RECOGN_STEADY', "-", "Shared Cockpit"),
			(b'MobiFlight.MV_COR_RECOGN_OFF', "-", "Shared Cockpit"),
			(b'MobiFlight.MV_COR_RECOGN_FLASH', "-", "Shared Cockpit"),
			(b'MobiFlight.MV_COR_LANDING_ON', "-", "Shared Cockpit"),
			(b'MobiFlight.MV_COR_LANDING_OFF', "-", "Shared Cockpit"),
			(b'MobiFlight.MV_COR_LANDING_AMBER', "-", "Shared Cockpit"),
			(b'MobiFlight.MV_COR_CHART_PLUS', "-", "Shared Cockpit"),
			(b'MobiFlight.MV_COR_CHART_MINUS', "-", "Shared Cockpit"),
			(b'MobiFlight.MV_COR_LPANEL_PLUS', "-", "Shared Cockpit"),
			(b'MobiFlight.MV_COR_LPANEL_MINUS', "-", "Shared Cockpit"),
			(b'MobiFlight.MV_COR_RPANEL_PLUS', "-", "Shared Cockpit"),
			(b'MobiFlight.MV_COR_RPANEL_MINUS', "-", "Shared Cockpit"),
			(b'MobiFlight.MV_COR_LINST_PLUS', "-", "Shared Cockpit"),
			(b'MobiFlight.MV_COR_LINST_MINUS', "-", "Shared Cockpit"),
			(b'MobiFlight.MV_COR_RINST_PLUS', "-", "Shared Cockpit"),
			(b'MobiFlight.MV_COR_RINST_MINUS', "-", "Shared Cockpit"),
			(b'MobiFlight.PMDG_DC6_AFE_BEFORE_START', "-", "Shared Cockpit"),
			(b'MobiFlight.PMDG_DC6_AFE_AFTER_START', "-", "Shared Cockpit"),
			(b'MobiFlight.PMDG_DC6_AFE_BEFORE_TAKEOFF', "-", "Shared Cockpit"),
			(b'MobiFlight.PMDG_DC6_AFE_TAKEOFF_DRY', "-", "Shared Cockpit"),
			(b'MobiFlight.PMDG_DC6_AFE_TAKEOFF_WET', "-", "Shared Cockpit"),
			(b'MobiFlight.PMDG_DC6_AFE_CRUISE', "-", "Shared Cockpit"),
			(b'MobiFlight.PMDG_DC6_AFE_DESCENT', "-", "Shared Cockpit"),
			(b'MobiFlight.PMDG_DC6_AFE_INRANGE', "-", "Shared Cockpit"),
			(b'MobiFlight.PMDG_DC6_AFE_BEFORE_LANDING', "-", "Shared Cockpit"),
			(b'MobiFlight.PMDG_DC6_AFE_AFTER_LANDING', "-", "Shared Cockpit"),
			(b'MobiFlight.PMDG_DC6_AFE_PARKING', "-", "Shared Cockpit"),
			(b'MobiFlight.PMDG_DC6_AFE_ABORT', "-", "Shared Cockpit"),
			(b'MobiFlight.PMDG_DC6_ADF_INNER_PLUS', "-", "Shared Cockpit"),
			(b'MobiFlight.PMDG_DC6_ADF_INNER_MINUS', "-", "Shared Cockpit"),
			(b'MobiFlight.PMDG_DC6_ADF_OUTER_PLUS', "-", "Shared Cockpit"),
			(b'MobiFlight.PMDG_DC6_ADF_OUTER_MINUS', "-", "Shared Cockpit"),
			(b'MobiFlight.PMDG_DC6_ADF_FREQ_SWITCH', "-", "Shared Cockpit"),
			(b'MobiFlight.PMDG_DC6_DME_1', "-", "Shared Cockpit"),
			(b'MobiFlight.PMDG_DC6_DME_2', "-", "Shared Cockpit"),
			(b'MobiFlight.PMDG_DC6_AP_MECHANICAL', "-", "Shared Cockpit"),
			(b'MobiFlight.PMDG_DC6_GYRO_PILOT', "-", "Shared Cockpit"),
			(b'MobiFlight.PMDG_DC6_ALTITUDE_CONTROL', "-", "Shared Cockpit"),
			(b'MobiFlight.PMDG_DC6_GYRO_PILOT_MODE_PLUS', "-", "Shared Cockpit"),
			(b'MobiFlight.PMDG_DC6_GYRO_PILOT_MODE_MINUS', "-", "Shared Cockpit"),
			(b'MobiFlight.PMDG_DC6_AP_TURN_PLUS', "-", "Shared Cockpit"),
			(b'MobiFlight.PMDG_DC6_AP_TURN_MINUS', "-", "Shared Cockpit"),
			(b'MobiFlight.PMDG_DC6_AP_AILERON_PLUS', "-", "Shared Cockpit"),
			...
			(b'MobiFlight.ASO_JU52_YOKE_HIDE', "-", "Shared Cockpit"),
			(b'MobiFlight.ASO_JU52_DME_STATE_1', "-", "Shared Cockpit"),
			(b'MobiFlight.ASO_JU52_DME_STATE_2', "-", "Shared Cockpit"),
			(b'MobiFlight.ASO_JU52_DME_STATE_3', "-", "Shared Cockpit"),
			(b'MobiFlight.ASO_JU52_DME_STATE_4', "-", "Shared Cockpit"),
			(b'MobiFlight.ASO_JU52_NAV_ADF_1_STATE_0', "-", "Shared Cockpit"),
			(b'MobiFlight.ASO_JU52_NAV_ADF_1_STATE_1', "-", "Shared Cockpit"),
			(b'MobiFlight.ASO_JU52_NAV_ADF_2_STATE_0', "-", "Shared Cockpit"),
			(b'MobiFlight.ASO_JU52_NAV_ADF_2_STATE_1', "-", "Shared Cockpit"),
			(b'MobiFlight.ASO_JU52_NAV_ADF_1_STATE_TOGGLE', "-", "Shared Cockpit"),
			(b'MobiFlight.ASO_JU52_NAV_ADF_2_STATE_TOGGLE', "-", "Shared Cockpit"),
			(b'MobiFlight.ASO_JU52_ADF_OFF', "-", "Shared Cockpit"),
			(b'MobiFlight.ASO_JU52_ADF_ANT', "-", "Shared Cockpit"),
			(b'MobiFlight.ASO_JU52_ADF_ADF', "-", "Shared Cockpit"),
			(b'MobiFlight.ASO_JU52_AP_HEADING_HOLD', "-", "Shared Cockpit"),
			(b'MobiFlight.ASO_JU52_AP_HEADING_HOLD2', "-", "Shared Cockpit"),
			(b'MobiFlight.ASO_JU52_AP_HEADING_HOLD3', "-", "Shared Cockpit"),
			(b'MobiFlight.ASO_JU52_AP_HEADING_HOLD4', "-", "Shared Cockpit"),
			(b'MobiFlight.ASO_JU52_AP_HEADING_HOLD5', "-", "Shared Cockpit"),
			(b'MobiFlight.ASO_JU52_AP_HEADING_HOLD6', "-", "Shared Cockpit"),
			(b'MobiFlight.ASO_JU52_AP_HEADING_HOLD7', "-", "Shared Cockpit"),
			(b'MobiFlight.ASO_JU52_AP_DISENGAGED', "-", "Shared Cockpit"),
			(b'MobiFlight.ASO_JU52_AP_ACTIVE', "-", "Shared Cockpit"),
			(b'MobiFlight.ASO_JU52C_PITOT_0', "-", "Shared Cockpit"),
			(b'MobiFlight.ASO_JU52C_PITOT_1', "-", "Shared Cockpit"),
			(b'MobiFlight.ASO_JU52C_PITOT_2', "-", "Shared Cockpit"),
			(b'NAV1_VOLUME_INC', "-", "Shared Cockpit"),
			(b'NAV1_VOLUME_DEC', "-", "Shared Cockpit"),
			(b'NAV2_VOLUME_INC', "-", "Shared Cockpit"),
			(b'NAV2_VOLUME_DEC', "-", "Shared Cockpit")
		]
